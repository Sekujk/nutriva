// Fuente: Instituto Nacional de Salud (INS) del Perú, Centro Nacional de Alimentación,
// Nutrición y Vida Saludable — "Tablas Peruanas de Composición de Alimentos", 11ª edición
// digital (marzo 2025), que reporta datos recolectados hasta 2023. Cubre 1125 alimentos
// más 567 preparaciones. Valores por 100 g de alimento, verificados directamente contra
// el PDF oficial: https://repositorio.ins.gob.pe/bitstreams/6cc030c5-daf4-4f19-9357-6910343796d9/download
// Subconjunto curado a mano; cuando la tabla no reporta un valor de fibra para un alimento
// vegetal (no analizado), se deja `fiber: null` en vez de asumir 0.

const foodsPeru = [
  // Cereales y derivados
  { name: 'Arroz blanco corriente', group: 'Cereales', kcal: 358, protein: 7.8, fat: 0.7, carbs: 77.6, fiber: null },
  ...
  { name: 'Maíz amarillo', group: 'Cereales', kcal: 355, protein: 6.7, fat: 4.8, carbs: 73.6, fiber: null },
  ...
  { name: 'Alcachofa', group: 'Verduras', kcal: 24, protein: 2.2, fat: 0.2, carbs: 18.9, fiber: 14.0 },
  ...
  { name: 'Manzana nacional', group: 'Frutas', kcal: 50, protein: 0.3, fat: 0.1, carbs: 14.6, fiber: 1.3 },
  { name: 'Naranja de Guayaquil', group: 'Frutas', kcal: 31, protein: 0.5, fat: 0.2, carbs: 10.2, fiber: 2.4 },
  { name: 'Palta', group: 'Frutas', kcal: 130, protein: 1.7, fat: 12.5, carbs: 5.6, fiber: null },
  ...
  { name: 'Plátano de isla', group: 'Frutas', kcal: 75, protein: 1.2, fat: 0.1, carbs: 21.6, fiber: 2.9 },
  ...
  { name: 'Uva negra', group: 'Frutas', kcal: 63, protein: 0.2, fat: 0.1, carbs: 18.1, fiber: 0.4 },
  ...
  { name: 'Pescado bonito', group: 'Pescados', kcal: 138, protein: 23.4, fat: 4.2, carbs: 0, fiber: 0 },
  { name: 'Pescado caballa, fresco', group: 'Pescados', kcal: 182, protein: 21.5, fat: 10.0, carbs: 0, fiber: 0 },
  ...
  { name: 'Pescado jurel, fresco', group: 'Pescados', kcal: 121, protein: 22.2, fat: 2.7, carbs: 0.3, fiber: 0 },
  ...
  { name: 'Pescado tilapia, fresco', group: 'Pescados', kcal: 100, protein: 18.4, fat: 2.1, carbs: 0.7, fiber: 0 },
  ...
  { name: 'Gallina, pierna de (sin piel)', group: 'Carnes', kcal: 120, protein: 20.6, fat: 3.6, carbs: 0, fiber: 0 },
  { name: 'Gallina, pechuga de (sin piel)', group: 'Carnes', kcal: 108, protein: 19.2, fat: 2.9, carbs: 0, fiber: 0 },
  { name: 'Pavo, carne de', group: 'Carnes', kcal: 160, protein: 20.4, fat: 8.0, carbs: 0, fiber: 0 },
  ...
  { name: 'Queso fresco de vaca', group: 'Lácteos', kcal: 265, protein: 17.2, fat: 20.2, carbs: 3.6, fiber: 0 },
  { name: 'Queso mantecoso', group: 'Lácteos', kcal: 322, protein: 19.5, fat: 26.5, carbs: 1.5, fiber: 0 },
  { name: 'Yogurt natural de leche descremada', group: 'Lácteos', kcal: 56, protein: 5.7, fat: 0.2, carbs: 7.7, fiber: 0 },

  // Huevos
  { name: 'Huevo de gallina entero, crudo', group: 'Huevos', kcal: 166, protein: 12.7, fat: 11.1, carbs: 2.9, fiber: 0 },
  ...
  { name: 'Huevo de codorniz, entero crudo', group: 'Huevos', kcal: 162, protein: 12.6, fat: 9.4, carbs: 6.0, fiber: 0 },
  ...
  { name: 'Olluco sin cáscara', group: 'Tubérculos', kcal: 59, protein: 1.1, fat: 0.1, carbs: 14.3, fiber: null },
  { name: 'Maca (tubérculo seco)', group: 'Tubérculos', kcal: 301, protein: 11.8, fat: 1.6, carbs: 66.3, fiber: null },
